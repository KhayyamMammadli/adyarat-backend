...
WhatsApp üzərindən Gemini, ChatGPT/OpenAI və Claude söhbəti, səs transkripsiyası, sənəd tərcüməsi və Runway video generasiyası dəstəklənir. Ətraflı sazlama üçün docs/AI_SETUP.md faylına baxın.
...
Tam addımlar: docs/META_SETUP.md.
...
Production üçün migration-u tətbiq edin və .env-ə server secret key əlavə edin. Təlimat: docs/SUPABASE_SETUP.md.
...
İstifadəçi məhsul şəklini göndərir.

Bot videoda nə baş verməli olduğunu soruşur.

İstifadəçi, məsələn, Kamera qəhvəyə yaxınlaşsın, buxar qalxsın, premium reklam olsun yazır.

Backend video işi yaradır.

Hazır MP4 həmin söhbətə göndərilir.
...
Ətraflı sxem: docs/ARCHITECTURE.md.
